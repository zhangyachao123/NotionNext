...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '喵桑', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一位朴素的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zhangyachao.co/', // 网站地址
